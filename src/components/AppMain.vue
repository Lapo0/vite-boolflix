                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="flag">
                                <img v-if="getFlag(store.selectedCard.original_language) !== null" :src="getFlag(store.selectedCard.original_language)" alt=" IMMAGINE NON DISPONIBILE ">
                            </div>
                            </div>
                            <div class="modal-footer">
